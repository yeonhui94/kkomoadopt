...
const QnaResultPage = () => {
  ...
  const {state: qnastate, actions: qnaaction} = QNAStore2();
  ...
  return (
    <div className={styles.qnaPageContainer}>
      <div className={styles.qnaPage}>
        ...
        <QnaResult postDetail={qnastate.qnaPostDetail} onAnswerSubmit={handleAnswerSubmit}/>
      </div>
    </div>
  );
};
