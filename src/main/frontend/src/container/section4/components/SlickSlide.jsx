...
function SlickSlide() {
  const slides = [
    ...
    { id: 4, img: img4_4, title: '입양한 고양이 미르의 첫날', nickname: '글쓴이 : sophia876', content: '미르가 집에 오고 나서 적응하기까지 시간이 걸렸지만, 이제는 정말 친근하게 다가와요!!', link:'/adoption-review/post/7200f7f2-18c2-4071-931f-be7bda31ce05' },
    { id: 5, img: img4_5, title: '입양한 고양이가 잘 지내고 있어요!', nickname: '글쓴이 : steve1980', content: '입양한 고양이가 이제 집에 적응해서 잘 지내고 있어요. 처음엔 낯설어했지만, 이제는 사람들과 함께 자고, 잘 먹고 잘 놀아요. 너무 행복합니다.', link:'/adoption-review/post/7993d9dd-2718-4ef4-bfec-2bee84885381' },
    { id: 6, img: img4_6, title: '우리 강아지 입양 후 첫날 이야기', nickname: '글쓴이 : mike23', content: '처음에는 조금 낯설어했지만, 이제는 우리 집에서 편안하게 지내고 있어요.\n너무 사랑스러운 강아지입니다.', link:'/adoption-review/post/0ab97bf5-b85b-4ed5-bddc-43565eb790a9' },
    { id: 7, img: img4_7, title: '입양한 강아지 구름이의 첫날', nickname: '글쓴이 : mike23', content: '처음에는 조금 낯설어했지만, 이제는 집안 곳곳을 돌아다니며 나랑 함께 놀자고 해요.', link:'/adoption-review/post/0bea6e68-30ea-4b6a-bd07-155e05a90f95' },
  ];
