...
//                   const postCategory = post ? post.postCategory : "전체"; // 게시글의 카테고리
//                   const postId = post ? post.postId : "게시글 없음"; // 게시글의 아이디
//                   return (
...
const MyComments = ({ gridArea }) => {
  ...
  useEffect(() => {
    ...
    // 데이터를 비동기적으로 가져온 후 로딩 완료 처리
    Promise.all([getMypageCommentListAction(), getMypageCommunityPostListAction()])
      .then(() => {
