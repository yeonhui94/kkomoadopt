            ...
            <div className={styles.EditMyPageDiv2}>
                ...
                <form className={styles.input1Form}>
                    ...
                    <InputBox
                        ...
                        marginBottom="40px"
                        value={nickname}
                        onChange={handleNicknameChange} // 값 변경 시 처리
                    />
                ...
                <div className={styles.input2}>
                    <InputBox
                        style={{ marginTop: "20px", gridArea: "contents3" }}
                        itype="tel"
                        text="휴대폰 번호"
                        backgroundColor="white"
                        height="95px"
                ...
                <div className={styles.SecondDividerWrapper2}>
                    <p style={{ fontSize: "20px" }}>비밀번호 변경</p>
                </div>
                ...
                <div className={styles.input3}>
                    <div>
                        <InputBox
                            ...
                            marginBottom="20px"
                            value={password1}
                            onChange={handlePassword} // 비밀번호 입력 시 값 변경 처리
                        />
                        {passwordMessage && (
                            <p
                                style={{
                                    position: "absolute",
                                    color: passwordMessage === '비밀번호가 일치합니다' ? 'green' : 'red',
                                    fontSize: '10px',
                                    marginLeft: "20px",
                                    marginTop: "-25px"
                                }}
                ...
                <Button text="수정" width="100%" marginLeft="10px"/>
            </div>
