...
const MainHeader = ({ isScrolled, currentSection, hamburgerm }) => {
  ...
  return (
    <div className={`${styles.headerGroup} ${isMenuOpen ? styles['menu-open'] : ''}`}>
      ...
      >
        <Link className={styles.logo} to="http://localhost:5173">
          ...
          >
            <div className={styles.menuFooter2}>
              ...
              <div style={{ paddingBottom: '20px', borderBottom: '1px solid var(--main-color)' }}>
                ...
                <Link className={styles.btn2} to="/mypage" onClick={()=>setIsMenuOpen(false)}>
